...
// https://github.com/craftizmv/gocql-fork-mv/issues/612
...
var (
	...
	ErrUseStmt              = errors.New("use statements aren't supported. Please see https://github.com/craftizmv/gocql-fork-mv for explanation.")
